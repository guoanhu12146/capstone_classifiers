...
def fit_transform_inputs(tweets):
    """
    ...
    tfidf_feats = tfidf_vectorizer.fit_transform(tweets).toarray()
    print("Built TF-IDF array")
    joblib.dump(tfidf_vectorizer, "../models/final_tfidf.pkl")
    ...
    pos_feats = pos_vectorizer.fit_transform(pos_tags).toarray()
    print("Built POS array")
    joblib.dump(pos_vectorizer, "../models/final_pos.pkl")
